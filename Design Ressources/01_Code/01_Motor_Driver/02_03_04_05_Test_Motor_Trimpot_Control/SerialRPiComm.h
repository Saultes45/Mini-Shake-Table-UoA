...
bool  goodMessageReceived_flag    = false;   // Initialise as "bad message"

char  RPI_SOM[] = "$$"; // SOM is a char*, used for Serial1.find
char  RPI_EOM   = ']'; // SOM is just a char (ie single character), used with "=", NOT with Serial1.find
